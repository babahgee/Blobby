import { generateUniqueID, getImage, rb } from "../essentials/essentials.js";
...
const textures = {
    grass: await getImage("./data/images/textures/texture_grass_01.jpg")
}
...
export class GridTile extends RenderObject {
    ...
    draw() {
        ...
        ctx.drawImage(textures.grass, this.x, this.y, this.tileWidth, this.tileHeight);
